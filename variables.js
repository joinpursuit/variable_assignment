...
tempInCelcius = (89 - 32) * 5 / 9;
tempInFahrenheit = (62 * 9 / 5 + 32);

console.log('The temp in celcius is ' + tempInCelcius);
console.log('The temp in fahrenheit is ' + tempInFahrenheit);
...
console.log(typeof ('My favorite number is ' + 42)); //sentence))
