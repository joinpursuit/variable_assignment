...
let currentAge = 39;
let maxAge = ageMax - currentAge;
let snacks = 3;
let snackYear = snacks * 365;
let snackNumber = snackYear * maxAge;

console.log('You will need ' + snackNumber + ' snacks to last you from now until the age of ' + ageMax);
...
console.log('the circumference of the circle is ' + circumferenceResult);
