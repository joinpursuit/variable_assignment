...
//
//
// let ageGap = ageMax - ageCurrent;
// let snackAmount = (ageGap * 365) * snackNumber;
//  console.log(' You will need ' + snackAmount + ' to last you until the age of ' + ageMax);
...
//
// let tempCelsius =  25;
// let tempInFahrenheit = (tempCelsius * 1.8) + 32;
// console.log(tempCelsius + ' °C is ' +  tempInFahrenheit + ' °F ')
//
// tempInFahrenheit = 50
// tempCelsius =  (tempInFahrenheit - 32) / 1.8
// console.log( tempInFahrenheit + ' °F is ' + tempCelsius + ' °C ')
