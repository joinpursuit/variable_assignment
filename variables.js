...
let futureYear = 2023;
let ageMin = (futureYear - 1) - birthYear;
...
const maxAge = 35;
const snackPerDay = 2;
let snackNumber = (maxAge - age) * 365 * snackPerDay;
...
console.log(tempInCelcius + " °C is " + tempInFahrenheit + " is " + tempInFahrenheit + " °F.");

tempInFahrenheit = 100;
